...
def add_kmax_deeplab_config(cfg):
    ...
    cfg.MODEL.KMAX_DEEPLAB.WITHIN_CLIP_TRACKING_MODULE = CN()
    cfg.MODEL.KMAX_DEEPLAB.WITHIN_CLIP_TRACKING_MODULE.ENABLE = False
    cfg.MODEL.KMAX_DEEPLAB.WITHIN_CLIP_TRACKING_MODULE.NAME = "WithinClipTrackingModule"
    cfg.MODEL.KMAX_DEEPLAB.WITHIN_CLIP_TRACKING_MODULE.NHEADS = 8
    cfg.MODEL.KMAX_DEEPLAB.WITHIN_CLIP_TRACKING_MODULE.DIM_FEEDFORWARD = 1024
    cfg.MODEL.KMAX_DEEPLAB.WITHIN_CLIP_TRACKING_MODULE.CONV_DIMS = 256
    cfg.MODEL.KMAX_DEEPLAB.WITHIN_CLIP_TRACKING_MODULE.DROPOUT = 0.0
    cfg.MODEL.KMAX_DEEPLAB.WITHIN_CLIP_TRACKING_MODULE.SPATIAL_IN_FEATURES = ['res3', 'res4', 'res5']
    cfg.MODEL.KMAX_DEEPLAB.WITHIN_CLIP_TRACKING_MODULE.SPATIAL_LAYERS = 2
