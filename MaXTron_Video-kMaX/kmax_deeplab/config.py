...
def add_kmax_deeplab_config(cfg):
    ...
    cfg.MODEL.CONVNEXTV2.IN_CHANNELS = 3
    cfg.MODEL.CONVNEXTV2.DEPTHS = [3, 3, 27, 3]
    cfg.MODEL.CONVNEXTV2.DIMS = [192, 384, 768, 1536]
    cfg.MODEL.CONVNEXTV2.DROP_PATH_RATE = 0.6
    cfg.MODEL.CONVNEXTV2.OUT_INDICES = [0, 1, 2, 3]
