...
from kmax_deeplab import (
    ...
    InstancekMaXDeepLabDatasetMapper_nocopypaste,
...
from tools.hdfs_hook import HdfsUploadHook
    ...
    def build_optimizer(cls, cfg, model):
        ...
        for module_name, module in model.named_modules():
            for module_param_name, value in module.named_parameters(recurse=False):
                ...
                if "spatial_encoder" in module_name:
                    hyperparams["lr"] = hyperparams["lr"] * cfg.SOLVER.MSDEFORM_MULTIPLIER
                if (
