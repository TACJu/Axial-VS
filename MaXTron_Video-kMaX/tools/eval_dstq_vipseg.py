...
def parse_args():
    ...
    parser.add_argument('--submit_dir', '-i', type=str, default='./inference',
                        help='test output directory')

    parser.add_argument('--truth_dir', type=str, default='./datasets/VIPSeg/VIPSeg_720P/panomasksRGB',
                        help='ground truth directory. Point this to <BASE_DIR>/VIPSeg/VIPSeg_720P/panomasksRGB '
                             'after running the conversion script')

    parser.add_argument('--pan_gt_json_file', type=str, default="./datasets/VIPSeg/VIPSeg_720P/panoptic_gt_VIPSeg_val.json",
