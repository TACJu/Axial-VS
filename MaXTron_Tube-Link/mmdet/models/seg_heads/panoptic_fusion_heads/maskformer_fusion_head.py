...
class MaskFormerFusionHead(BasePanopticFusionHead):
    ...
    def instance_postprocess(self, mask_cls, mask_pred, img_shape):
    ...
    def simple_test(self,
        ...
        for mask_cls_result, mask_pred_result, meta in zip(
            ...
            if rescale and not instance_on:
                print('we are still rescaling')
            ...
            if instance_on:
                ins_results = self.instance_postprocess(
                    mask_cls_result, mask_pred_result, meta['ori_shape'])
