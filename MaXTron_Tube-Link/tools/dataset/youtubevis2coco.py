...
def convert_vis(ann_dir, save_dir, dataset_version, mode='train'):
    ...
    """
    assert dataset_version in ['2019', '2021', '2022', 'ovis']
    ...
    if dataset_version == '2019':
        ...
        official_anns = mmcv.load(osp.join(ann_dir, mode, f'annotations_{mode}.json'))
...
def main():
    ...
    for sub_set in ['train', 'valid', 'test']:
        if args.version == '2022' and sub_set == 'train':
            continue
